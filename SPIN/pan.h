...
#define nstates3	3	/* Check */
#define minseq3	27
#define maxseq3	28
#define endstate3	2

#define nstates2	10	/* Reset */
#define minseq2	18
#define maxseq2	26
#define endstate2	9

#define nstates1	10	/* Dec */
#define minseq1	9
#define maxseq1	17
#define endstate1	9

#define nstates0	10	/* Inc */
#define minseq0	0
#define maxseq0	8
#define endstate0	9
...
#define PCheck	((P3 *)this)
typedef struct P3 { /* Check */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define PReset	((P2 *)this)
typedef struct P2 { /* Reset */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
