...
set xversion "iSpin Version 1.1.0 -- 7 June 2012"
...
### Colors
	...
	set V_Panel_3	0 ;# Advanced verification options 3: Default Parameters
...
proc explain5 {} {
	...
	$vo insert end "\t-o4	turn on rendezvous optiomizations in verifier\n"
	$vo insert end "\t-o5	turn on case caching (reduces size of pan.m, but can affect reachability reports)\n"
	$vo insert end "\t-o6	to revert to the old rules for interpreting priority tags (pre 6.2)\n\n"
	$vo insert end "\tOr you can define preprocessor directives, e.g. -DNPROCS=4\n\n"
	$vo yview end
}
...
proc run_sim {} {
	...
	if {$V_Panel_3} {
		set args "-p -s -r -X -v -n$seed [$vpanel.top.right.row5.ent get]"
	} else {
